...
function disableRestrictedFeatures() {
  ...
  if (cartBtn) {
    ...
    cartLink.innerHTML = `<i class="fas fa-shopping-cart"></i><span class="tooltiptext">Inicia sesión para acceder al carrito</span>`
  ...
  if (wishlistBtn) {
    ...
    wishlistLink.innerHTML = `<i class="fas fa-heart"></i><span class="tooltiptext">Inicia sesión para guardar favoritos</span>`
  ...
  if (searchBtn) {
    ...
    searchLink.innerHTML = `<i class="fas fa-search"></i><span class="tooltiptext">Inicia sesión para buscar</span>`
  ...
  addToCartBtns.forEach((btn) => {
    ...
    btn.innerHTML = `<i class="fas fa-shopping-cart"></i><span class="tooltiptext">Inicia sesión para comprar</span>`
  ...
  wishlistBtns.forEach((btn) => {
    btn.classList.add("tooltip", "disabled-btn")
    btn.innerHTML = `<i class="far fa-heart"></i><span class="tooltiptext">Inicia sesión para guardar favoritos</span>`
